...
template <typename T>
__global__ void
cuckooInsertKernel_Naive(const T * const vals, const int n,
...
template <typename T>
__global__ void
cuckooDeleteKernel_Naive(const T * const vals, const int n,
                         T * const data, const int size,
                         const FuncConfig * const hash_func_configs, const int num_funcs,
                         const int pos_width) {
...
template <typename T>
__global__ void
cuckooLookupKernel_Naive(const T * const vals, bool * const results, const int n,
...
CuckooHashTableCuda_Naive<T>::lookup_vals(const T * const vals, bool * const results, const int n) {
    ...
    // Launch the lookup kernel.
    cuckooLookupKernel_Naive<<<ceil((double) n / BLOCK_SIZE), BLOCK_SIZE>>>(d_vals, d_results, n,
                                                                            d_data, _size,
                                                                            d_hash_func_configs, _num_funcs,
                                                                            _pos_width);
